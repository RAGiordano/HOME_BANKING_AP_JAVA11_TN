...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(
		...
		return (args) -> {
			...
			Client client2 = new Client("Richard", "Dean Anderson", "richarddanderson@mindhub.com", passwordEncoder.encode("98765aA#"), ClientRoleType.CLIENT);
			Client client3 = new Client("Admin", "Admin", "admin@mindhub.com", passwordEncoder.encode("Admin12#"), ClientRoleType.ADMIN);
			...
			// Create Card objects
			Card card1 = new Card(CardType.DEBIT, CardUtils.generateCardNumber(),CardUtils.generateCVV(), actualDate, thruDate, client1.getLastName() + " " + client1.getFirstName(), CardColor.GOLD);
			Card card2 = new Card(CardType.CREDIT, CardUtils.generateCardNumber(),CardUtils.generateCVV(), actualDate, thruDate, client1.getLastName() + " " + client1.getFirstName(), CardColor.TITANIUM);
			Card card3 = new Card(CardType.DEBIT, CardUtils.generateCardNumber(),CardUtils.generateCVV(), actualDate, thruDate, client2.getLastName() + " " + client2.getFirstName(), CardColor.SILVER);
